...
export default class extends Controller {
  ...
  transitionToReducedState() {
    ...
    this.element.querySelector('.logo-menu').classList.add('clipped-logo');
  ...
  toggleElementsVisibility({
    ...
    if (arrows !== null) {
      [this.arrowTarget, this.arrowForwardTarget].forEach(arrow => 
        arrows ? arrow.classList.remove('hidden') : arrow.classList.add('hidden'));
    }
    if (hamburger !== null) {
      hamburger 
    ...
    if (logoReduzida !== null) {
      logoReduzida 
        ? this.logoReduzidaTarget.classList.remove('hidden') 
        : this.logoReduzidaTarget.classList.add('hidden');
      logoReduzida 
        ? this.logoReduzidaCircleTarget.classList.remove('hidden') 
        : this.logoReduzidaCircleTarget.classList.add('hidden');
    }
    if (menuTexts !== null) {
      this.menuTextTargets.forEach(text => 
        menuTexts ? text.classList.remove('hide-text', 'hide-text-hidden') : text.classList.add('hide-text-hidden'));
    }
  }
}