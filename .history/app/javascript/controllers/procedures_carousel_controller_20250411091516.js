...
export default class extends Controller {
  ...
  handleTouchMove(event) {
    ...
    const translateX = -this.currentPageValue * this.containerTarget.offsetWidth + diff
  ...
  resetPosition() {
    this.containerTarget.style.transform = `translateX(${-this.currentPageValue * this.containerTarget.offsetWidth}px)`
  }
