...
export default class extends Controller {
  ...
  setInitialIcon() {
    ...
    this.iconTargets.forEach(icon => {
      ...
      // Reseta para o ícone padrão primeiro
      icon.src = icon.dataset.iconDefault;
      // Aplica seleção apenas se corresponder à rota atual
  ...
  toggleElementsVisibility({
    ...
    if (arrows !== null) {
      // [CORREÇÃO] Mantém arrow-forward sempre oculto no estado expandido
      this.arrowTarget.classList.toggle('hidden', !arrows);
      this.arrowForwardTarget.classList.toggle('hidden', true); // Sempre oculto
    }
    if (hamburger !== null) {
      hamburger 
